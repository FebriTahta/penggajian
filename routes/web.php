...
Route::get('/cari_data_absensi',[pegawaicontroller::class,'page_cari_data_absensi']);
Route::get('daftar',[pegawaicontroller::class,'page_daftar']);
Route::get('/simpanpegawai',[pegawaicontroller::class,'page_simpanpegawai']);
...
Route::get('/updateitempegawai',[pegawaicontroller::class,'page_updateitempegawai']);
Route::get('/bacapenggajian',[pegawaicontroller::class,'page_bacapenggajian']);
Route::get('potongan',[pegawaicontroller::class,'page_potongan']);
Route::get('/simpanpotongan',[pegawaicontroller::class,'page_simpanpotongan']);
Route::get('updatepotongan/{id}',[pegawaicontroller::class,'page_updatepotongan']);
Route::get('/updateitempotongan',[pegawaicontroller::class,'page_updateitempotongan']);
Route::get('deletepotongan/{id}',[umumcontroller::class,'page_hapuspotongan']);
Route::get('jabatan',[umumcontroller::class,'page_jabatan']);
Route::get('/simpanjabatan',[umumcontroller::class,'page_simpanjabatan']);
Route::get('updatejabatan/{id}',[umumcontroller::class,'page_updatejabatan']);
Route::get('/updateitemjabatan',[umumcontroller::class,'page_updateitemjabatan']);
Route::get('deletejabatan/{id}',[umumcontroller::class,'page_hapusjabatan']);
Route::get('tunjangan',[umumcontroller::class,'page_tunjangan']);
Route::get('/simpantunjangan',[umumcontroller::class,'page_simpantunjangan']);
